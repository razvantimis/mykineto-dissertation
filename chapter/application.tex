...
% In acest sens am implementat peste algoritmul de estimare a posturi cele doua abordari detaliate in introducerea lucrari,
%   cel care caulculeaza rang of motion si calcularea distantelor pentru afisarea progresului pacientului.
...
%  Fiecare aplicatie implementeaza o abordarea diferite. 
Each application implements a different approach.

%  Aplicatie web calculeaza Range of Motion pentru a ajuta kinetoterapeutul sa faca o evaluare mai eficenta, pe langa
%  asta vom numera numarul repetari a unui exercitiu pe care pacientul  il va efectua
